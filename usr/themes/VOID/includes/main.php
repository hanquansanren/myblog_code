            ...
            <section id="post" class="float-up">
                <article class="post yue">
                    ...
                    <div style="margin: 20px auto;width: fit-content;">----- <span style="color: white;background-color: black;padding: 0 5px;font-size: .7rem;">END</span> -----</div>              
                        ...
                        <p class="notice">
                        本文作者：<i class="glyphicon glyphicon-user"></i>&nbsp;<a class="meta-value" href="<?php $this->author->permalink(); ?>" rel="author"> <?php $this->author(); ?></a><br>
                        本文链接：<a class="content-copyright" href="<?php $this->permalink(); ?>"><i class="glyphicon glyphicon-link"></i>&nbsp;<?php $this->permalink(); ?></a><br>
                        <!--版权声明：<i class="glyphicon glyphicon-alert"></i>&nbsp;本文章采用<a rel="license" href="https://creativecommons.org/licenses/by-nc-sa/4.0/"><i><strong>&nbsp;知识共享署名-非商业性使用-相同方式共享 4.0 国际许可协议&nbsp;</strong></i></a>进行许可。-->
                    ...
                    <!-- <blockquote class="content-copyright" style="font-style:normal">
                        本文作者：<i class="glyphicon glyphicon-user"></i>&nbsp;<a class="meta-value" href="<?php $this->author->permalink(); ?>" rel="author"> <?php $this->author(); ?></a><br>
                        本文链接：<a class="content-copyright" href="<?php $this->permalink(); ?>"><i class="glyphicon glyphicon-link"></i>&nbsp;<?php $this->permalink(); ?></a><br>
                        版权声明：<i class="glyphicon glyphicon-alert"></i>&nbsp;本文章采用<a rel="license" href="https://creativecommons.org/licenses/by-nc-sa/4.0/"><i><strong>&nbsp;知识共享署名-非商业性使用-相同方式共享 4.0 国际许可协议&nbsp;</strong></i></a>进行许可。<img alt="知识共享许可协议" style="border-width:0" src="https://i.creativecommons.org/l/by-nc-sa/4.0/80x15.png" />
                    </blockquote> -->



 <div style="margin: 20px auto;width: fit-content;"> <span style="color: white;background-color: black;padding: 0 6px;font-size: 1.1rem;">都看到这里了，不点个赞，投个币再走嘛，球球了 ~ ~ ~</span> </div>
                    ...
                    <div class="social-button" 
                        ...
                        <?php if(!empty($setting['reward'])):?>
                            <a data-fancybox="gallery-reward" role=button aria-label="赞赏" data-src="#reward" href="javascript:;" class="btn btn-normal btn-highlight">投币支持</a>
                        ...
                        <?php if($setting['VOIDPlugin']):?>
                            ...
                            >点个赞呗 <span class="value"><?php echo $this->likes; ?></span>
                            </a>
                        <?php endif; ?>
                        <span>分享到</span>
