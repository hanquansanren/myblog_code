...
?>
        <footer>
            <div class="container wide">
                <section>
                    <p>© 2020-<?php echo date('Y '); ?> <span class="brand"><?php echo $this->options->title; ?></span></p>
                    <p>感谢陪伴：<span id="uptime"></span></p>
                                        <p>总访问量：576次<p>
                </section>
                <section>
                    <p>All Rights Reserved.</p>
                                        <!--  <p><a href="https://www.beian.gov.cn/portal/registerSystemInfo" target="_blank">粤公网安备41xxxxxx号</a></p>
                    <p><a href="https://beian.miit.gov.cn/" target="_blank">粤ICP备2021130321号</a></p>  -->
                    <p>
